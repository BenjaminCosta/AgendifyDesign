  ...
  return (
    ...
    >
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="fill-transparent stroke-[#4edea399] font-[helvetica] text-7xl font-bold"
      ...
      {/* Gradient reveal on mouse hover */}
      <text
        x="50%"
        y="50%"
        textAnchor="middle"
...
export const FooterBackgroundGradient = () => (
  <div
    ...
    style={{
      background:
        "radial-gradient(125% 125% at 50% 10%, #0e0e0e88 50%, #4edea322 100%)",
    }}
  />
);
